...
-- depends_on: {{ source('test_normalization', '_airbyte_raw_pull_request_stats') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['merged'], ['merged']) }} as merged,
    {{ json_extract_scalar('_airbyte_data', ['number'], ['number']) }} as number,
    {{ json_extract_scalar('_airbyte_data', ['commits'], ['commits']) }} as commits,
    ...
    {{ json_extract_scalar('_airbyte_data', ['additions'], ['additions']) }} as additions,
    ...
    {{ json_extract_scalar('_airbyte_data', ['deletions'], ['deletions']) }} as deletions,
    {{ json_extract_scalar('_airbyte_data', ['issue_url'], ['issue_url']) }} as issue_url,
    {{ json_extract_scalar('_airbyte_data', ['mergeable'], ['mergeable']) }} as mergeable,
    {{ json_extract_scalar('_airbyte_data', ['merged_at'], ['merged_at']) }} as merged_at,
    {{ json_extract('table_alias', '_airbyte_data', ['merged_by'], ['merged_by']) }} as merged_by,
    ...
    {{ json_extract('table_alias', '_airbyte_data', ['auto_merge']) }} as auto_merge,
    {{ json_extract_scalar('_airbyte_data', ['created_at'], ['created_at']) }} as created_at,
    {{ json_extract_scalar('_airbyte_data', ['rebaseable'], ['rebaseable']) }} as rebaseable,
    ...
    {{ json_extract_scalar('_airbyte_data', ['changed_files'], ['changed_files']) }} as changed_files,
    {{ json_extract_scalar('_airbyte_data', ['mergeable_state'], ['mergeable_state']) }} as mergeable_state,
    {{ json_extract_array('_airbyte_data', ['requested_teams'], ['requested_teams']) }} as requested_teams,
    {{ json_extract_scalar('_airbyte_data', ['review_comments'], ['review_comments']) }} as review_comments,
    ...
    {{ json_extract_scalar('_airbyte_data', ['maintainer_can_modify'], ['maintainer_can_modify']) }} as maintainer_can_modify,
    _airbyte_ab_id,
    _airbyte_emitted_at,
    {{ current_timestamp() }} as _airbyte_normalized_at
from {{ source('test_normalization', '_airbyte_raw_pull_request_stats') }} as table_alias
-- pull_request_stats
where 1 = 1
