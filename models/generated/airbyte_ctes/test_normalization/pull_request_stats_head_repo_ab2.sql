...
-- depends_on: {{ ref('pull_request_stats_head_repo_ab1') }}
select
    ...
    cast(forks as {{ dbt_utils.type_bigint() }}) as forks,
    ...
    cast(watchers as {{ dbt_utils.type_bigint() }}) as watchers,
    ...
    cast(pushed_at as {{ dbt_utils.type_string() }}) as pushed_at,
    ...
    {{ cast_to_boolean('allow_forking') }} as allow_forking,
    ...
    cast(temp_clone_token as {{ dbt_utils.type_string() }}) as temp_clone_token,
    ...
    {{ cast_to_boolean('allow_merge_commit') }} as allow_merge_commit,
    {{ cast_to_boolean('allow_rebase_merge') }} as allow_rebase_merge,
    {{ cast_to_boolean('allow_squash_merge') }} as allow_squash_merge,
    _airbyte_ab_id,
    _airbyte_emitted_at,
    {{ current_timestamp() }} as _airbyte_normalized_at
from {{ ref('pull_request_stats_head_repo_ab1') }}
