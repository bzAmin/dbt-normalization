...
{{ unnest_cte('pull_request_stats', 'pull_request_stats', 'requested_reviewers') }}
select
...
-- requested_reviewers at pull_request_stats/requested_reviewers
{{ cross_join_unnest('pull_request_stats', 'requested_reviewers') }}
where 1 = 1
